...
const HeroPicture = () => {
    return (
        <div className={`${styles.flexCenter} flex-1 flex-col`}>
            ...
            <img src="https://cdn.discordapp.com/attachments/1031263201763016704/1035642824173031515/vt_.png" alt="film"
                 className="absolute w-[6.123rem] h-[6.054rem] top-[58.1rem] left-[.9rem]
            ...
            <img src="https://cdn.discordapp.com/attachments/1031263201763016704/1035642823443239002/vt_.png" alt="slate"
                 className="absolute w-[7.687rem] h-[5.179rem] left-[17.1rem] top-[58.5rem] xl:w-[28.625rem] xl:h-[22.813rem] xl:left-[67.5rem] xl:top-[82.5rem] z-0"/>
        </div>
    )
}
